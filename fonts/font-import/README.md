...
| wiki-use.css | Made for specified use on the [Hypixel SkyBlock Wiki](https://hypixelskyblock.minecraft.wiki/) | `@import url('https://cdn.jsdelivr.net/gh/skyblock-wiki/wiki-assets@1.0/fonts/font-import/lib/wiki-use.css')`<br />Note: Implementation may change without notice |